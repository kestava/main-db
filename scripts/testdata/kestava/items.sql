...
INSERT INTO kestava.items (item_id, title, additional_description, quantity, loc, ref_user_account_id)
...
ALTER SEQUENCE kestava.items_item_id_seq RESTART WITH 16;
